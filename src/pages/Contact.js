  ...
  return (
    <>
      ...
      <Section id="contact" className="max-w-3xl">
        ...
        <p className="text-white/70 mb-6">Have a project, question, or collaboration in mind? Drop a message and I will respond promptly.</p>
        <form className="space-y-5" action="https://formspree.io/f/xnqgvoyj" method="POST" acceptCharset="UTF-8" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <input id="name" name="name" type="text" required className="w-full bg-white/5 border border-white/10 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-brand-purple" placeholder="Your name" />
          </div>
          <div>
            <label className="text-sm font-medium block mb-1" htmlFor="email">Email</label>
            <input id="email" name="email" type="email" required className="w-full bg-white/5 border border-white/10 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-brand-purple" placeholder="you@example.com" />
          </div>
          <div>
            <label className="text-sm font-medium block mb-1" htmlFor="message">Message</label>
            <textarea id="message" name="message" rows="5" required className="w-full bg-white/5 border border-white/10 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-brand-purple" placeholder="Share details..." />
          </div>
          ...
          <div className="text-xs text-white/40 flex items-center gap-2"><Mail size={14}/> Or email: hello@tosinadelaja.com</div>
        </form>
      </Section>
    </>
  );
