...
const base = 'inline-flex items-center gap-2 rounded-xl font-medium text-sm transition focus:outline-none focus:ring-2 focus:ring-brand-purple focus:ring-offset-2 focus:ring-offset-bg';
const variants = {
  ...
  subtle: 'px-5 py-3 bg-white/5 border border-white/10 hover:bg-white/10',
